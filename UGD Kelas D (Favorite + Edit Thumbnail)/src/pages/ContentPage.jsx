...
import { GetMyContents, DeleteContent, UpdateThumbnail } from "../api/apiContent";
...
const ContentPage = () => {
  ...
  const onFileChange = (event) => {
    ...
    UpdateThumbnail(currentId, formData).then((response) => {
      setIsPending(false);
  ...
  return (
    <Container className="mt-4">
      ...
      <input className="d-none" type="file" onChange={onFileChange} accept="image/*" id="thumbnail" />
    </Container>
  );
};
